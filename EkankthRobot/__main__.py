...
⏤͟͟͞͞•𓊈𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 @PragyanIITIAN 𓊉
...
buttons = [
    [
        InlineKeyboardButton(
            text="★ 𝐀𝐝𝐝 𝐌𝐞 ★ ",
            url=f"https://t.me/PragyanIITIAnBOT?startgroup=true",
        ),
    ],
    [
        InlineKeyboardButton(text="🍁𝐆𝐑𝐎𝐔𝐏🍁", url=f"https://t.me/AboutPragyanIITIAn"),
        InlineKeyboardButton(text="⚙️𝐇𝐄𝐋𝐏⚙️", callback_data="help_back"),
    ],
    [
        
        InlineKeyboardButton(text="🌷𝐎𝐰𝐧𝐞𝐫🌷", url=f"https://t.me/PragyanIITIAn"),
        InlineKeyboardButton(text="🥀𝐎𝐅𝐅𝐈𝐂𝐄🥀", url=f"https://t.me/Kabutargang"),
    ],
    [
        InlineKeyboardButton(
            text="🌱𝐒𝐎𝐔𝐑𝐂𝐄🌱",
      url=f"https://t.me/KabutarGang",
        ),
    ],
]
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        ...
                        InlineKeyboardButton(
                            text="ɢɪᴛʜᴜʙ",
                            callback_data="https://github.com/AvyukthX/AvyukthXBot",
                        ),
                    ],
                    [
